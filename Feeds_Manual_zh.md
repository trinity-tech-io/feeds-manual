...
* FeedsDev
  ...
  ![图片](Image/common/FeedsDev.png)

* elastOS

  ![图片](Image/common/elastOS.png)

* Tuum Tech

  ![图片](Image/common/TuumTech.png)
...
2. 点击右上角图标，进入菜单页：
   ...
   ![图片](Image/zh/feedsadd-1.jpg)

3. 点击进入“微频源”界面，如果还未绑定或者添加过，就在下面左图上点击“添加微频源”；如果已添加过请点击下面右图上“添加新的微频源”。

   ![图片](Image/zh/feedsadd-2.jpg)![图片](Image/zh/feedsadd-3.jpg)
...
* 点击“扫描微频源二维码”；
  ...
  ![图片](Image/zh/feedsadd-4.jpg)![图片](Image/zh/feedsadd-5.jpg)

5. 微频源添加成功后，可在微频源界面看到新添加的微频源。

   ![图片](Image/zh/feedsadd-6.jpg)

6. 进入探索微频源界面，刷新界面，可加载所有已添加的微频源下创建的所有微频。关注指定微频后，可以在“我的时间线”下查看到已关注的所有微频发布的微说。用户可以点赞微说，也可以对此微说添加微评。

   ![图片](Image/zh/feedsadd-7.jpg)![图片](Image/zh/feedsadd-8.jpg)
...
2. 启动安装微频服务
   ...
   ![图片](Image/common/Ubuntu-1.jpg)

   下载完成后，自动进入“Ubuntu Software”中 对应的安装包界面：

   ![图片](Image/common/Ubuntu-2.jpg)

   点击“Install”进行安装，根据提示输入计算机的密码：

   ![图片](Image/common/Ubuntu-3.jpg)

   完成安装后，刚显示的安装包界面显示“Install”按钮变为“Remove”。

   ![图片](Image/common/Ubuntu-4.jpg)
...
1. 点击tab页上的“+”号图标，选择用来发布的微频后跳转到编辑页面；
   ...
   ![图片](Image/zh/post-1.jpg)![图片](Image/zh/post-2.jpg)

2. 可以输入文字，也可以通过点击“添加图片”选择图片，编辑完毕后点击“发布”即可完成发布。

   ![图片](Image/zh/post-3.jpg)
...
![图片](Image/zh/q6-2.png)

点击“仍要打开”，然后在弹出的确认打开界面继续点击“打开”，则会打开Feeds Service，然后在弹出的请求链接上点击“允许”即可。

![图片](Image/zh/q6-3.png)![图片](Image/zh/q6-4.png)

**Q7：Feeds Service服务的数据文件在哪里？**

**答：**

该服务是运行在本地的，数据库文件默认是存储在home下的“.feedsd/”。![图片](Image/common/q7.png)
